...
import { Alert, Button, Dropdown, message, Space, Tooltip,Drawer } from "antd";
...
const Header = () => {
  ...
  const items = [
    {
      label: <span>Đến trang admin</span>,
      key: "1",
      icon: <LoginOutlined />,
      hidden: user?.maLoaiNguoiDung === "QuanTri" ? false : true,
  ...
  return (
    ...
    //           <NavDropdown.Item style={{height:"50px" }} href="" className="pe-none">
